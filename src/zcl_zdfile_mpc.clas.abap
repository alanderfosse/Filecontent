class ZCL_ZDFILE_MPC definition
  public
...
CLASS ZCL_ZDFILE_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZDFILE_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZDFILE_MPC=>TS_FILE' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250225070129'.                  "#EC NOTEXT
